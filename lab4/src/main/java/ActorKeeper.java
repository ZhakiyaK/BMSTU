...
public class ActorKeeper extends AbstractActor {
    ...
    public Receive createReceive() {
        return receiveBuilder()
                ...
                .match(JSTestApp.MessageGetTestPackageResult.class, req -> sender().tell(new MessageReturnResults(req.getPackageID(), results.get(req));           --(new MessageReturnResults(req.getPackageID(), results.get(req.getPackageID())), self()))
                .build();
    }
