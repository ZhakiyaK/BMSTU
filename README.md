...
### О чем пойдет речь? 
Данный репозиторий представляет собой открытый архив учебных материалов и результатов академической работы во время обучения в МГТУ им. Н.Э. Баумана.

### Содержание
Содержание репозитория:
1. [Алгоритмы и структуры данных](./Algorithms%20and%20data%20structures/) (1 курс 1 семестр)
...
6. [Алгоритмы компьютерной графики](./Computer%20Graphics%20Algorithms/) (2 курс 4 семестр)
